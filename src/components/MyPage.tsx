...
export function MyPage({ user, books, purchases, allBooks, users, onClose, onPasswordChange, onEditBook, onDeleteBook, onUpdateBook, onUpdateUser, onDeleteUser, isDarkMode }: MyPageProps) {
                  ...
                  <div className="space-y-3">
                    {books.map((book) => {
                      ...
                      return (
                        <div
                          key={book.id}
                          className={`border rounded-lg overflow-hidden hover:shadow-md transition-all p-4 ${
                            isDarkMode 
                              ? 'bg-gray-700 border-gray-600' 
                              : 'bg-white border-gray-200'
                          }`}
