...
import { X, Key, BookOpen, Edit2, Trash2, CheckCircle, AlertCircle, Package, Calendar, ShoppingCart, Plus, Minus, Search, ArrowUpDown, ChevronDown, ChevronUp, Star, Clock, BookMarked, FileText, Hash, Building2, Users, Mail, UserX, User as UserIcon, TrendingUp, XCircle, DollarSign } from 'lucide-react';
