...
export const USER_ENDPOINTS = {
   ...
   * @response Book[]
   */
  GET_USER_BOOKS: (userId) => `/user/book/${userId}`,
   ...
   * @response Order[]
   */
  GET_USER_ORDERS: (userId) => `/user/order/${userId}`,
};
...
export const BOOK_ENDPOINTS = {
   ...
   * @response Book
   */
  GET_BOOK_BY_ID: (bookId) => `/book/${bookId}`,
   ...
   * @response Book
   */
  UPDATE_BOOK: (bookId) => `/book/${bookId}`,
   ...
   */
  REGENERATE_COVER: (bookId) => `/book/${bookId}`,
   ...
   * @response Book
   */
  UPDATE_STOCK: (bookId) => `/book/${bookId}/stock`,
};
...
export const COMMENT_ENDPOINTS = {
   ...
   * @response Review
   */
  CREATE_COMMENT: (bookId) => `/comment/${bookId}`,
...
export const ORDER_ENDPOINTS = {
   ...
   */
  PAY_ORDER: (orderId) => `/order/${orderId}/pay`,
   ...
   * @response OrderResponse
   */
  GET_ORDER: (orderId) => `/order/${orderId}`,
};
